...
func TestCheckErrorWithDebugInformation(t *testing.T) {
	...
	cmd.Flags().Bool("html", false, "output explain trace as an interactive HTML file")
	cmd.Flags().String("html-output", "trace.html", "path for HTML output file (used with --html)")
